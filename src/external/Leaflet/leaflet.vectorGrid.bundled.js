...
;(function (factory) {
    ...
    ;(function () {
        ...
        })(typeof window.self !== 'undefined' ? window.self : undefined)
        ...
        function readUtf8(buf, pos, end) {
            ...
            while (i < end) {
                ...
                var bytesPerSequence =
                    b0 > 0xef ? 4 : b0 > 0xdf ? 3 : b0 > 0xbf ? 2 : 1
        ...
        function signedArea(ring) {
            var sum = 0
            for (
                var i = 0, len = ring.length, j = len - 1, p1, p2;
                i < len;
                j = i++
            ) {
                p1 = ring[i]
        ...
        var PointSymbolizer = L.CircleMarker.extend({
            ...
            render: function (renderer, style) {
                ...
                this._radius =
                    style.radius || L.CircleMarker.prototype.options.radius
                this._updatePath()
            },
            ...
            updateStyle: function (renderer, style) {
                ...
                this._updateBounds()
                return Symbolizer.prototype.updateStyle.call(
                    this,
                    renderer,
                    style
                )
                ...
                vectorTilePromise.then(
                    function renderTile(vectorTile) {
                        for (var layerName in vectorTile.layers) {
                            ...
                            var pxPerExtent = this.getTileSize().divideBy(
                                layer.extent
                            )
                            ...
                            for (var i = 0; i < layer.features.length; i++) {
                                ...
                                var featureLayer = this._createLayer(
                                    feat,
                                    pxPerExtent
                                )
                ...
                return fetch(tileUrl, this.options.fetchOptions)
                    ...
                    .then(function (json) {
                        ...
                        for (var layerName in json.layers) {
                            ...
                            for (
                                var i = 0;
                                i < json.layers[layerName].length;
                                i++
                            ) {
        ...
        L.Canvas.Tile = L.Canvas.extend({
            ...
            _onClick: function (e) {
                ...
                for (var i = keys.length - 1; i >= 0; i--) {
                    var id = keys[i]
                    if (
                        this._map._layers[id]._vectorTiles &&
                        this._map._layers[id].options.interactive
                    ) {
                ...
                if (clickedLayer) {
                    ...
                    point.x =
                        (clickedLayer._pxBounds.min.x +
                            clickedLayer._pxBounds.max.x) /
                        2
                    point.y =
                        (clickedLayer._pxBounds.min.y +
                            clickedLayer._pxBounds.max.y) /
                        2
