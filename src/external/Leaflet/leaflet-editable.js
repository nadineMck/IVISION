...
;(function (factory) {
    ...
    L.Editable = L.Evented.extend({
        ...
        createFeaturesLayer: function () {
            return (
                this.options.featuresLayer || new L.LayerGroup().addTo(this.map)
            )
        },
        ...
        createPolyline: function (latlngs, options) {
            return this.createLayer(
                (options && options.polylineClass) ||
                    this.options.polylineClass,
                latlngs,
                options
            )
        },
        ...
        createRectangle: function (bounds, options) {
            return this.createLayer(
                (options && options.rectangleClass) ||
                    this.options.rectangleClass,
                bounds,
                options
            )
        },
    ...
    L.Editable.MiddleMarker = L.Marker.extend({
        ...
        setVisibility: function () {
            var leftPoint = this._map.latLngToContainerPoint(this.left.latlng),
                rightPoint = this._map.latLngToContainerPoint(
                    this.right.latlng
                ),
        ...
        computeLatLng: function () {
            var leftPoint = this.editor.map.latLngToContainerPoint(
                    this.left.latlng
                ),
                rightPoint = this.editor.map.latLngToContainerPoint(
                    this.right.latlng
                ),
    ...
    L.Editable.BaseEditor = L.Handler.extend({
        ...
        hasMiddleMarkers: function () {
            return (
                !this.options.skipMiddleMarkers &&
    ...
    L.Editable.PathEditor = L.Editable.BaseEditor.extend({
        ...
        addVertexMarker: function (latlng, latlngs) {
            return new this.tools.options.vertexMarkerClass(
                latlng,
                latlngs,
                this
            )
    ...
    L.Editable.PolygonEditor = L.Editable.PathEditor.extend({
        ...
        addNewEmptyShape: function () {
            if (
                ...
                this.feature._latlngs[0].length
            ) {
                var shape = []
                this.appendShape(shape)
                return shape
        ...
        ensureMulti: function () {
            if (
                this.feature._latlngs.length &&
                isFlat(this.feature._latlngs[0])
            ) {
                this.feature._latlngs = [this.feature._latlngs]
            }
        },
    ...
    L.Editable.CircleEditor = L.Editable.PathEditor.extend({
        ...
        onDrawingMouseDown: function (e) {
            ...
            this._resizeLatLng.__vertex.dragging._draggable._onDown(
                e.originalEvent
            )
        },
    ...
    var EditableMixin = {
        createEditor: function (map) {
            map = map || this._map
            var tools =
                (this.options.editOptions || {}).editTools || map.editTools
    ...
    var PolylineMixin = {
        ...
        isInLatLngs: function (l, latlngs) {
            ...
            for (i = 1, len = part.length, k = 0; i < len; k = i++) {
                if (
                    L.LineUtil.pointToSegmentDistance(p, part[k], part[i]) <= w
                ) {
                    return true
                }
            }
    ...
    var PolygonMixin = {
        ...
        isInLatLngs: function (l, latlngs) {
            ...
            for (
                j = 0, len2 = latlngs.length, k = len2 - 1;
                j < len2;
                k = j++
            ) {
                l1 = latlngs[j]
