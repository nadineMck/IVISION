    ...
    L.leafletPip = (function e(t, n, r) {
                ...
                function (require, module, exports) {
                    ...
                    var leafletPip = {
                        ...
                        pointInLayer: function (p, layer, first) {
                            ...
                            else if (leafletPip.bassackwards)
                                p = p.concat().reverse()
                ...
                function (require, module, exports) {
                    ;(function () {
                        ...
                        gju.lineStringsIntersect = function (l1, l2) {
                            ...
                            for (
                                var i = 0;
                                i <= l1.coordinates.length - 2;
                                ++i
                            ) {
                                for (
                                    var j = 0;
                                    j <= l2.coordinates.length - 2;
                                    ++j
                                ) {
                                    var a1 = {
                        ...
                        ;(gju.pointDistance = function (pt1, pt2) {
                            ...
                            (gju.geometryWithinRadius = function (
                                geometry,
                                center,
                                radius
                            ) {
                                if (geometry.type == 'Point') {
                                    return (
                                        gju.pointDistance(geometry, center) <=
                                        radius
                                    )
                                } else if (
                                    ...
                                    for (var i in coordinates) {
                                        ...
                                        if (
                                            gju.pointDistance(point, center) >
                                            radius
                                        ) {
                                            return false
                                        }
        ...
        either side of line joining start & end points */
                        ...
                        gju.destinationPoint = function (pt, brng, dist) {
                            ...
                            lon2 =
                                ((lon2 + 3 * Math.PI) % (2 * Math.PI)) - Math.PI // normalise to -180..+180º
