...
;(function (factory) {
    ...
    */
        closestLayerSnap: function (
            ...
            withVertices =
                typeof withVertices == 'boolean' ? withVertices : true
            ...
            if (withVertices && typeof result.layer.getLatLngs == 'function') {
                ...
                if (closest.distance < tolerance) {
                    ...
                    result.distance = L.GeometryUtil.distance(
                        map,
                        closest,
                        latlng
                    )
    ...
    */
     ...
     */
        extract: function (map, polyline, start, end) {
            ...
            var latlngs = polyline.getLatLngs(),
                startpoint = L.GeometryUtil.interpolateOnLine(
                    map,
                    polyline,
                    start
                ),
